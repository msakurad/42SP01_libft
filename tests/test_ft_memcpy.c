...
void	test_ft_memcpy_ftvslibc_usingsamestring_true(void)
{
	...
	memcpy(str_lib, &str_lib[10],5);
	ft_memcpy(str_ft, &str_ft[10],5);
	printf("\nDepois cmp ft %s vs lib %s\n\n", str_ft, str_lib);
	TEST_ASSERT_EQUAL_STRING(str_lib, str_ft);
}
...
*/
void	test_ft_memcpy_ftvslibc_overlapsrcgreaterthandest_undefined(void)
{
	char str_lib[50] = "palha com batata";
	char str_ft[50] = "palha com batata";
	...
	memcpy(str_lib, &str_lib[4],7);
	ft_memcpy(str_ft, &str_ft[4],7);
	printf("\nDepois cmp ft %s vs lib %s\n\n", str_ft, str_lib);
...
no mesmo endereço de memória.
*/
void	test_ft_memcpy_ftvslibc_overlapdestgreaterthansrc_undefined(void)
{
	char str_lib[50] = "palha com batata";
	char str_ft[50] = "palha com batata";
	...
	memcpy(&str_lib[5], &str_lib[2],7);
	ft_memcpy(&str_ft[5], &str_ft[2],7);
	printf("\nDepois cmp ft %s vs lib %s\n\n", str_ft, str_lib);
	TEST_IGNORE_MESSAGE("teste ft vs lib overlap -> return undefined");
	TEST_ASSERT_EQUAL_STRING(str_lib, str_ft);
}
...
void	run_test_ft_memcpy(void)
{
	...
	RUN_TEST(test_ft_memcpy_ftvslibc_usingsamestring_true);
	RUN_TEST(test_ft_memcpy_ftvslibc_overlapdestgreaterthansrc_undefined);
	RUN_TEST(test_ft_memcpy_ftvslibc_overlapsrcgreaterthandest_undefined);
	RUN_TEST(test_ft_memcpy_ftvslibc_intarraynormalconditions_true);
	//RUN_TEST(test_ft_memcpy_ftvslibc_intarrayoverlaparrayitself_undefined);
	UNITY_END();
}
